...
export const address: string = '0xfe8c6d19365453d26af321d0e8c910428c23873f';
export const abi: AbiItem | AbiItem[] = [
  ...
  {
    inputs: [],
    name: 'MAX_PER_WHITELISTED_WALLET',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      { internalType: 'address', name: 'addressToExempt', type: 'address' },
      { internalType: 'bool', name: 'shouldExampt', type: 'bool' },
    ],
    name: 'limitExempt',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'address', name: 'statsContract', type: 'address' },
    ],
  ...
  {
    inputs: [{ internalType: 'bool', name: 'isWhitelistOnly', type: 'bool' }],
    name: 'updateSaleWhitelist',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
