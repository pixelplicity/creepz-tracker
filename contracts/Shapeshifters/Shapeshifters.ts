...
export const address: string = '0xF1083e064F92db0561fd540F982Cbf73A4e2F8f6';
export const abi: AbiItem | AbiItem[] = [
  ...
  {
    inputs: [
      { internalType: 'address', name: '_megaAddress', type: 'address' },
    ],
    name: 'setMegaAddress',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_timeoutInSeconds', type: 'uint256' },
    ],
    name: 'updatePurchaseTimeout',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
